#@Login
Feature: Login scenarios of The-Companion365 Website
         # LoginNegative1
    @negative
    ...
    #LoginPositive1
  Scenario: User try to login to the Easy-Appointments homepage by entering valid username and password
    Given User is on the Easy-Appointments home page
    When User enters username and password
